...
### Nintendo Switch Controller Testing App for Android
...
| Feature | Description |
|---|---|
| 🔘 **Buttons** | B A Y X • L/R • ZL/ZR • +/− • Home ⌂ • Capture ◻ |
| 🕹️ **Sticks** | Real-time visualization with AXIS_Z/RZ + RX/RY fallback |
| 🎯 **Triggers** | Precise ZL/ZR pressure display |
| 🔊 **Vibration** | Test HD Rumble: short, medium, long + pattern |
